...
# Function to delete everything in the volume
...
# Function to download and flatten the model
def download_and_flatten_model(model_path, snapshot_base_path, final_model_path):
    try:
        ...
        # Flatten model files into final path
...
if __name__ == "__main__":
    # Define the correct path for RunPod Serverless persistent volume after clearing it
    ...
    # Step 1: Clear the volume
    clear_volume(model_path)

    # Step 2: Download and flatten model
    model_path = download_and_flatten_model(model_path, snapshot_base_path, final_model_path)
